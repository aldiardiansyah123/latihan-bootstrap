...
<html lang="en">
  ...
  <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
    <div class="navbar-nav">
      ...
      <a class="nav-item nav-link" href="index.php">latihan 3 <span class="sr-only">(current)</span></a>
  ...
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
        ...
        <p class="card-text">Sebuah software untuk memudahkan para programer untuk membuat seuah aplikasi
        web yang di dalamnya ada berbagai fungsi diantaranya plugin.</p>
